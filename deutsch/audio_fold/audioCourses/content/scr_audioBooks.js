...
*/
		...
		function recount_height(){
			if(int_shelf<2){
				height_center.style.height=586+"px";
				height_left.style.height=586-50+"px";
				height_right.style.height=586-50+"px";
...
//-----------------------------------
		function new_frame(){
			...
			switch(this.id){
				case "num0": my_frame.src = "https://www.youtube.com/embed/DjufuMDV9D8";
					caption.innerHTML=this.innerHTML; break;
				case "num1": my_frame.src = "https://www.youtube.com/embed/WnLSdMemZrk";
					caption.innerHTML=this.innerHTML; break;
				case "num2": my_frame.src = "https://www.youtube.com/embed/p3-eYfT8-Ok";
					caption.innerHTML=this.innerHTML; break;
